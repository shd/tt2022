...
\item Покажите, что аксиома счётного выбора (для $\{ A_n \}$, что $\forall n \in \mathbb{N}.A_n \ne \varnothing$, существует 
$f: \mathbb{N} \rightarrow \cup A_n$, что $f(k) \in A_k$) следует из аксиомы детерменированности (т.е. придумайте подходящую игру).
...
аксиомы детерменированности и аксиомы выбора.
\begin{enumerate}
...
\item Пусть $T = \{I_n \ |\ I_n \setminus A --- \text{ 1 категории Бэра}\}$ и $A' = A \triangle \cup T$. Покажите, что 
